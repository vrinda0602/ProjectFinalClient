...
const Organisation = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8000/org/organisations', {
      ...
      body: JSON.stringify(formData)//converts javascript object/array to json string
    })
            ...
            <p>
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    <td><input type="checkbox" name="skillsNeeded" value="Fullstack Developer" checked={formData.skillsNeeded.includes('Fullstack Developer')} onChange={handleChange} disabled={isSubmitted || !isEditing} />Fullstack Developer</td>
